"""
WikiEvents constrained zero-shot baseline using Qwen2.5-7B-Instruct.
Provides the full list of valid event types in the prompt.
"""
...
OUT_FILE   = "/mnt/parscratch/users/acp25ck/team-rg1/results/wikievents_qwen_eval_constrained_results.jsonl"
MAX_DOCS   = 50
MAX_NEW_TOKENS = 100
...
print("Building event type label set from train split...")
label_set = set()
...
for i, sample in enumerate(samples):
    ...
    # Check if model stayed within the label set
...
n = len(results)
print("\n" + "="*60)
print("WIKIEVENTS CONSTRAINED ZERO-SHOT -- RESULTS")
print("="*60)
